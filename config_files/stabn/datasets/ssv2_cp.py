...
if __name__ == '__main__':
    ...
    debug_dataset = SomethingSomethingV2(
        video_data_dir="/raid/noguchi/dataset/something-something-v2/frame",
        label_file="/raid/noguchi/dataset/something-something-v2/anno/train_videofolder.txt",
